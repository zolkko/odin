...
object RSTParserMain {
  ...
  def main(args: Array[String]) {
    ...
    if (props.containsKey("train")) {
      ...
      val (trees, cs) = CacheReader.mkTrees(props.getProperty("train"), props.containsKey("dep"))
    ...
    if (props.containsKey("test")) {
      ...
      val (trees, _) = CacheReader.mkTrees(props.getProperty("test"), props.containsKey("dep"), makeStats = false)
