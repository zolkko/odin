  ...
  def main(args: Array[String]) {
    ...
    if (props.containsKey("train")) {
      ...
      val (trees, corpusStats) =
        CacheReader.mkTrees(props.getProperty("train"), props.containsKey("dep"))
    ...
    if (props.containsKey("test")) {
      val (trees, _) =
        CacheReader.mkTrees(props.getProperty("test"), props.containsKey("dep"), makeStats = false)
      if (props.containsKey("model")) {
    ...
    if (props.containsKey("fsel")) {
      cls = new EDUClassifier
      val (trees, corpusStats) =
        CacheReader.mkTrees(props.getProperty("fsel"), props.containsKey("dep"))
