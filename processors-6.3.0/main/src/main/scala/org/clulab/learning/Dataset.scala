...
/**
  ...
  */
abstract class Dataset[L, F](val labelLexicon: Lexicon[L], val featureLexicon: Lexicon[F], val labels: ArrayBuffer[Int]) extends Serializable {
...
/**
  ...
  */
class BVFDataset[L, F](ll: Lexicon[L], fl: Lexicon[F], ls: ArrayBuffer[Int], val features: ArrayBuffer[Array[Int]]) extends Dataset[L, F](ll, fl, ls) {

  def this() = this(new Lexicon[L], new Lexicon[F], new ArrayBuffer[Int], new ArrayBuffer[Array[Int]])
  ...
  override def keepOnly(featuresToKeep: Set[Int]): Dataset[L, F] = {
    ...
    new BVFDataset[L, F](
      labelLexicon,
      featureLexicon.mapIndicesTo(featureIndexMap.toMap),
      labels,
      newFeatures
    )
  }
...
/**
  ...
  * @tparam F Type of features
  */
class RVFDataset[L, F](ll: Lexicon[L], fl: Lexicon[F], ls: ArrayBuffer[Int], fs: ArrayBuffer[Array[Int]], val values: ArrayBuffer[Array[Double]])
    extends BVFDataset[L, F](ll, fl, ls, fs)
    with FeatureTraversable[F, Double] {
...
class InformationGain(var datumCount: Int = 0, val datumsByClass: Counter[Int] = new Counter[Int]) {
...
object RVFDataset {
  ...
  def saveToSvmLightFormat(datums: Iterable[Datum[Int, String]], featureLexicon: Lexicon[String], fn: String) {
...
/**
  ...
  */
class CounterDataset[L, F](ll: Lexicon[L], fl: Lexicon[F], ls: ArrayBuffer[Int], val features: ArrayBuffer[Counter[Int]]) extends Dataset[L, F](ll, fl, ls) {
