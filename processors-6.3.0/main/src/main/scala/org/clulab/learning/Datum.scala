...
/**
  ...
  * @tparam F
  */
class BVFDatum[L, F](val label: L, val features: Iterable[F]) extends Datum[L, F] {
...
/**
  ...
  * @tparam F
  */
class RVFDatum[L, F](val label: L, val featuresCounter: Counter[F]) extends Datum[L, F] {
...
/**
  ...
  * @tparam F
  */
class RVFKDatum[L, F](label: L, featuresCounter: Counter[F], val kernel: String) extends RVFDatum[L, F](label, featuresCounter) {
