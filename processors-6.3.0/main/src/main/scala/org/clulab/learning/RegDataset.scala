...
/**
  ...
  * Date: 11/15/17
  */
abstract class RegDataset[F](val featureLexicon: Lexicon[F], val labels: ArrayBuffer[Double]) extends Serializable {
...
/**
  ...
  */
class BVFRegDataset[F](fl: Lexicon[F], ls: ArrayBuffer[Double], val features: ArrayBuffer[Array[Int]]) extends RegDataset[F](fl, ls) {

  def this() = this(new Lexicon[F], new ArrayBuffer[Double], new ArrayBuffer[Array[Int]])
...
/**
  ...
  * @tparam F Type of features
  */
class RVFRegDataset[F](fl: Lexicon[F], ls: ArrayBuffer[Double], fs: ArrayBuffer[Array[Int]], val values: ArrayBuffer[Array[Double]])
    extends BVFRegDataset[F](fl, ls, fs)
...
object RVFRegDataset {
  ...
  def saveToSvmLightFormat(datums: Iterable[Datum[Double, String]], featureLexicon: Lexicon[String], fn: String) {
...
/**
  ...
  */
class CounterRegDataset[F](fl: Lexicon[F], ls: ArrayBuffer[Double], val features: ArrayBuffer[Counter[Int]]) extends RegDataset[F](fl, ls) {
