...
class LiblinearClassifier[L, F](
    ...
    val classWeights: Option[Array[(L, Double)]] = None
) extends Classifier[L, F]
    with Serializable {
  ...
  private def rvfDataToFeatures(feats: Array[Int], vals: Array[Double], sorted: Boolean): Array[Feature] = {
...
/**
  ...
  */
class LogisticRegressionClassifier[L, F](C: Double = 1.0, eps: Double = 0.01, bias: Boolean = false, classWeights: Option[Array[(L, Double)]] = None)
    extends LiblinearClassifier[L, F](SolverType.L2R_LR, C, eps, bias, classWeights)

/**
  * LR with L1 regularization
  */
class L1LogisticRegressionClassifier[L, F](C: Double = 1.0, eps: Double = 0.01, bias: Boolean = false, classWeights: Option[Array[(L, Double)]] = None)
    extends LiblinearClassifier[L, F](SolverType.L1R_LR, C, eps, bias, classWeights)

/**
  * Linear SVM with L2 regularization
  */
class LinearSVMClassifier[L, F](C: Double = 1.0, eps: Double = 0.01, bias: Boolean = false, classWeights: Option[Array[(L, Double)]] = None)
    extends LiblinearClassifier[L, F](SolverType.L2R_L2LOSS_SVC, C, eps, bias)

/**
  * Linear SVM with L1 regularization
  */
class L1LinearSVMClassifier[L, F](C: Double = 1.0, eps: Double = 0.01, bias: Boolean = false, classWeights: Option[Array[(L, Double)]] = None)
